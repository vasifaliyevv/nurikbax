...
const Index = () => {
  ...
  const formik = useFormik({
    ...
    onSubmit: values => {
      ...
      axios.post('http://localhost:8080/api/courses',values).then((res)=>console.log(res.data))
    },
  });
  return (

    <div className={styles.add} style={{backgroundColor:"RGB(43, 43, 43)",display:"flex"}}>
